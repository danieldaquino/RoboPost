function RobotDataCSV() {
	...
	that.Init = function() {
		that.Text = "Timestamp, last Sensor Position, Linear Speed Setpoint, Linear Speed measurement, Curve Radius Setpoint, Curve Radius Measured, Left RPM setpoint, Left RPM, Right RPM setpoint, Right RPM, Left PWM Frequency, Left PWM Duty Cycle, Right PWM Frequency, Right PWM Duty Cycle, RGBColor, , DesiredSpeed, SharpestCurve, Cruise Kp, Cruise Kd, Cruise Ki, DBrake, PBrake, Decay Rate, Motor Kp, Motor Kd\n";
	}
